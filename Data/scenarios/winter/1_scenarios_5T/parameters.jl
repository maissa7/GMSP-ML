...
B_minus_omega_t = convert(Dict{String, Array{Float64, 1}}, JSON.Parser.parse(open(string(FOLDER, "/price_scenarios1.json"), "r"))["Beta_minus"]);
...
println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
println("~                                                        ~")
println("~      Season: winter       |   Number of scenarios: 1   ~")
println("~                                                        ~")
println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
